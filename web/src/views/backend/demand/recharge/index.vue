            ...
            <el-dialog title="审核" :z-index="1000" v-model="addPurchasingManagementDialog.show" @close="DialogCloseFn(1)" center destroy-on-close draggable>
                ...
                <template #footer>
                    <div class="dialog-footer">
                        <el-button :disabled="addPurchasingManagementDialog.isClickedShow" type="primary" @click="confirmAddCommodityFn(1)" >确认</el-button>
...
const confirmAddCommodityFn = (type:number = 1) => {
    addPurchasingManagementDialog.isClickedShow = true;
    ...
    let confirmFn = async () => {
        ...
        setTimeout(() => {
            addPurchasingManagementDialog.isClickedShow = false; // 处理完成后再启用按钮
        }, 3000);
    }
    confirmFn()
