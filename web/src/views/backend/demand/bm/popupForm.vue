        ...
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            ...
            >
                ...
                >
                    ...
                    <FormItem v-if="baTable.form.items!.account_id" :label="t('demand.bm.demand_type')" type="select" v-model="baTable.form.items!.demand_type" prop="demand_type" :input-attr="{ content: { '1': t('demand.bm.demand_type 1'), '2': t('demand.bm.demand_type 2'), '3': t('demand.bm.demand_type 3') }, onChange:citiesFn }" :placeholder="t('Please select field', { field: t('demand.bm.demand_type') })" />
                    <FormItem v-if="baTable.form.items!.demand_type != 3" :label="t('demand.bm.bm')" type="string" v-model="baTable.form.items!.bm" prop="bm" :placeholder="t('Please input field', { field: t('demand.bm.bm') })" />
